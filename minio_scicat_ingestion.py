...
# File to ingest
FILE_PATH = r"C:\Users\avriza\Desktop\pyscicat\pedot_pss_all_data_set\Test_1_2022-02-24_17-50-54_9aed6d1fcf.json"  # Change this to the actual file path
THUMBNAIL_PATH = r"C:\Users\avriza\Desktop\pyscicat\examples\test2\SC52aT_R1-2_4D-5-FROMYDRIVE.dm4.png"
...
minio_client = Minio(
    f"{MINIO_SERVER}:9000",  # Use localhost if running on the same machine
...
def upload_to_minio(file_path: str) -> str:
    ...
    file_url = f"http://{MINIO_SERVER}:9001/{MINIO_BUCKET}/{file_name}"
    return file_url
...
def register_in_scicat(file_path: str, file_url: str, thumbnail_path: str):
...
def upload_and_register(file_path: str, thumbnail_path: str):
    ensure_minio_bucket()
